...
/**
 * Feature-компонент: инпут поиска с бизнес-логикой и работой с API
 */
export function SearchInputFeature({ searchLocationList }: Props) {
                      ...
                      {data.projects.map((project) => (
                        ...
                        >
                          ...
                          <p className="text-xs text-muted-foreground">
                            {project?.client?.name} • {formatDate(project.created_at)}
                          </p>
                        </div>
                      ))}
                    </div>
